            ...
            <div className="w-11/12 h-60  flex flex-col">
                ...
                <div className="w-full h-1/2  border-b border-4-black flex">
                    ...
                    <div className="w-1/3 h-full   flex flex-col pl-3 gap-0.5 py-2 justify-center items-center">
                        ...
                        <h2 className="font-bold text-[15px] text-black">ANALYTICAL REPORT</h2>
                        <span className="text-[15px] text-black">For Project:</span>
                        <h2 className="font-bold text-[10px] text-black">{ projectName }</h2>
                ...
                <div className="w-full h-1/2 flex  mt-2">
                    ...
                    <div className="w-1/2 h-full flex flex-col gap-1 pr-3 items-end">
